...
public class Ship implements Runnable {
	private final static String UNLOAD_MESSAGE_FORMAT = "%s: unloaded a cargo unit. Remaining - %d";
	private String name;
	...
	public String toString() {
		return "Ship [name=" + name + ", cargoCount=" + cargoCount + ", " + "cargoUnitUnloadTime=" + cargoUnitUnloadTime
				+ "]";
	}
	...
	public void run() {
		while (cargoCount > 0) {
			...
			cargoCount--;
			System.out.println(String.format(UNLOAD_MESSAGE_FORMAT, name, cargoCount));
			try {
